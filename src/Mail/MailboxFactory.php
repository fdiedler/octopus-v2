...
class MailboxFactory
{
    ...
    // Used by AirbnbBot class
    public function openSecurityCodesInbox(): Server
    {
        $server = new Server($this->securityCodesHost, self::SSL_IMAP_PORT);
        $server->setAuthentication($this->securityCodesEmail, $this->securityCodesPassword);
